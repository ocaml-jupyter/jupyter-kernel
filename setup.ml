...
(* OASIS_START *)
(* DO NOT EDIT (digest: 635635e0f8cbb02f35ce565305083bed) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ocaml-jupyter/jupyter-kernel";
          bugreports = None;
          synopsis = "A library for writing jupyter kernels";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "jupyter-kernel";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\127\177zO\167\212\026&\249>\149\233\141k\154~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
